...
public class SalesContracts extends Contract {
    private int id;
    ...
    public SalesContracts(String date, String customerName, String customerEmail, Vehicle vehicleSold, boolean financeOption) {
